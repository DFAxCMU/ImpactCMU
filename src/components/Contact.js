...
export default function Contact() {
    return <section id="contact">
        <h1>Contact</h1>
        <div>Feel free to reach out about any questions and follow us on social media!</div>
        <div style={{ 
            display: 'flex',
            flexDirection: 'row',
        }}>
            ...
            <a href="mailto:impactcmu.dfa@gmail.com?subject=ImpactCMU question" target="_blank">
