...
export default function Contact() {
    return <section id="contact">
        <h1>Contact</h1>
        <div>Feel free to reach out about any questions and follow DFA@CMU on social media</div>
        <div style={{ 
            display: 'flex',
            flexDirection: 'row',
        }}>
            <a href="https://www.facebook.com/dfacmu/" target="_blank">
            ...
            <a href="https://www.instagram.com/dfa.cmu/" target="_blank">
            ...
            <a href="mailto:carnegiemellon@designforamerica.com?subject=ImpactCMU question" target="_blank">
