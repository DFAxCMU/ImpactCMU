    ...
    <section id="timeline">
        <div className="content">
            <div className="center">
                <h1>Projects</h1>
                <p><strong>Come out support and view the work of our showcase participants</strong></p>
            </div>
            <div className="four-col">
                <div className="container">
                    ...
                    <div className="projectCard">
                        <p class="item"><small><strong>Balance Boxes CMU</strong></small></p>
                        <p class="item"><small>Sydney Holubow, Olivia McCracken, Skylar Lukic, Ruby Perez Fry, Ethan Sharf, Qingqing Zhao</small></p>
                    </div>
                    <div className="projectCard">
                        <p class="item"><small><strong>Project Runway</strong></small></p>
                        <p class="item"><small>Myria Mathew, Jinjin Du, Aditi Bamel, Mizuki Kadowaki, Karthik Sivacharan, Ramneek Kaur</small></p>
                    </div>
                    <div className="projectCard">
                ...
                <div className="container">
                    ...
                    <div className="projectCard">
                        ...
                        <p class="item"><small>Adrienne Li, Mengrou Shou, Martin Cheong</small></p>
                    </div>
                    <div className="projectCard">
                ...
                <div className="container">
                    ...
                    <div className="projectCard">
                        <p class="item"><small><strong>Ambit: Self-Reflective Device for Adults with ADHD</strong></small></p>
                        <p class="item"><small>Julia "Jubbies" Steinweh-Adler</small></p>
                    </div>
                    <div className="projectCard">
                        <p class="item"><small><strong>Littoral Society Coastal Degradation Rhetorical Analysis and Development</strong></small></p>
                        <p class="item"><small>Matthew Blankley</small></p>
                    </div>
                    <div className="projectCard">
